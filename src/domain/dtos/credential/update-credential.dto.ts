...
export class UpdateCredentialDTO {
    ...
    static create(object: { [key: string]: any }): [string?, UpdateCredentialDTO?] {
        const { name, password, description, code1, code2 } = object;
        ...
        return [
            undefined,
            new UpdateCredentialDTO(name, password, description, code1, code2),
        ];
    }
}